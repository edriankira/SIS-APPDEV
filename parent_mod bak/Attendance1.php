						...
						<div class="inner">
							...
							<!-- Banner -->
								<section id="banner">
									<div class="content">
										<header>
											<h2 id="titleview">Final Attendace</h2>
										</header>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="mt-5 mb-3 clearfix">
                                                                    ...
                                                                    <form action="Attendance1.php" class="src" method="POST" > 
                                                                ...
                                                                $sql="SELECT *FROM fct_midterm WHERE userid LIKE '%$searching%' AND section LIKE '%$lname%'";
