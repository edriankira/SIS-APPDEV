				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="index.html" class="logo"><strong>Academic</strong> Performance</a>
									<ul class="icons"><?php
									...
									<ul>
										...
										<li>
											...
											<ul>
                                                                                            ...
                                                                                            <li style="color:#ff6666;"><a href="GENERALacademics.php">Academic Performance<i class="fa fa-caret-left" aria-hidden="true" style="margin-left: 10px; font-size: 20px;"></i></a></li>
