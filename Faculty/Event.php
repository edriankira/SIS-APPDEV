						...
						<div class="inner">
							...
							<!-- Banner -->
								<section id="banner">
									...
									<button style="float:right;"><a href="Event_add.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New User</button></a>
                                    <br><br>
									<?php
                                        // Include config file
                                                ...
                                                echo '<table class="table table-bordered table-striped">';
                                                    ...
                                                    while($row = mysqli_fetch_array($result)){
                                                        ...
                                                        echo "<td>";
                                                                ...
                                                                echo '<a href="Event_delete.php?id='. $row['adm_evtID'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                                            echo "</td>";
                                                        echo "</tr>";
                                                    }
                                                    echo "</tbody>";                            
