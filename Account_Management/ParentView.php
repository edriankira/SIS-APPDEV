...
<body>
    ...
    <div id="container">
        ...
        <table id="crudtable">
           ...
           echo '<a href="ParentUpdate.php?id='.$row['adm_prtId'].'"><button id="modifyingbtn"><i class="fa fa-pencil" style="color:white; font-size:20px;"></i></button></caption></a>' ?>
            <tr>
            ...
            <tr>
                ...
                <td colspan = 2 id="namet"><b><?php 
                    echo $row["adm_prtfname"]. " ". $row["adm_prtmname"]. " ". $row["adm_prtlname"];
                    ?>
                    <b></td>
            </tr>
            <tr>
                <td>Username</td>
                <td colspan=2 id="usert"><b><?php echo $row["adm_prtusername"]; ?><b></td>
            </tr>
            <tr>
                <td colspan=3 id="firstline"></td>
            </tr>
            <tr>
                <td><?php echo $row["adm_prtbday"]; ?><br><b>Birthdate<b></td>
                <td><?php echo $row["adm_prtgender"]; ?><br><b>Gender<b></td>
                <td><?php echo $row["adm_prtUserNum"]; ?><br><b>ID</b></td>
            ...
            <tr>
                <td colspan = 2 id="emailt"><?php echo $row["adm_prtemail"] ?><br><b>Email</b></td>
                <td><?php echo $row["adm_prtmobile"]; ?><br><b>Mobile<b></td>
            </tr>
            <tr>
                <td colspan=3 id="firstline"></td>
            </tr>
