           ...
           echo '<a href="Edit.php?id='.$row['adm_stdId'].'"><button id="modifyingbtn"><i class="fa fa-pencil" style="color:white; font-size:20px;"></i></button></caption></a>' ?>
            ...
            <tr>
                ...
                <td colspan = 2 id="namet"><b><?php 
                    echo $row["adm_stdfname"]. " ". $row["adm_stdmname"]. " ". $row["adm_stdlname"];
                    ?>
                    <b></td>
            </tr>
            <tr>
                <td>Username</td>
                <td colspan=2 id="usert"><b><?php echo $row["adm_stdusername"]; ?><b></td>
            </tr>
            <tr>
                <td colspan=3 id="firstline"></td>
            </tr>
            <tr>
                <td><?php echo $row["adm_stdbday"]; ?><br><b>Birthdate<b></td>
                <td><?php echo $row["adm_stdgender"]; ?><br><b>Gender<b></td>
                <td><?php echo $row["adm_stdUserNum"]; ?><br><b>ID</b></td>
            ...
            <tr>
                <td colspan = 2 id="emailt"><?php echo $row["adm_stdemail"] ?><br><b>Email</b></td>
                <td><?php echo $row["adm_stdmobile"]; ?><br><b>Mobile<b></td>
            </tr>
            <tr>
                <td colspan=3 id="firstline"></td>
            </tr>
