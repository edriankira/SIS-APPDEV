...
<body>
    ...
    <div id="container">
        ...
        <table id="crudtable">
           ...
           echo '<a href="AdminUpdate.php?id='.$row['adm_AdminId'].'"><button id="modifyingbtn"><i class="fa fa-pencil" style="color:white; font-size:20px;"></i></button></caption></a>' ?>
            <tr>
        ...
        <input type="submit" class="backread" value="Back" onClick="location.href='AdminManagement.php'"/>
    </div>
