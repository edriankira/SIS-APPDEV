				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="" class="logo"><strong>Parent </strong>Management</a>
									<ul class="icons"><?php
							...
							<!-- Banner -->
								<section id="banner">
									<div class="content">
										<header>
											<h2 id="titleview">Parents Users List</h2>
										</header>
										<div id ="viewAdmin">
											<table>
												<tr>
...
function Display(){
    ...
    $sql = "select * from adm_ParentUser";
    ...
    if($result = mysqli_query($db, $sql)){
        if(mysqli_num_rows($result) > 0){
            while($row = mysqli_fetch_array($result)){
				...
				if(isMobileDevice()){
					echo "<tr>";
						echo "<td>" . $row['adm_prtlname'] ."$lnameholder " .$row['adm_prtfname']. $row['adm_prtmname']. "</td>";
						echo "<td>" . $row['adm_prtstatus'] . "</td>";
						echo "<td>";
						echo '<a href="ParentView.php?id='. $row['adm_prtAdminId'] .'"><button id="modify">View</button></a>';
							// echo '<a href="update.php?id='. $row['adm_prtAdminId'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
							// echo '<a href="delete.php?id='. $row['adm_prtAdminId'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
						echo "</td>";
					echo "</tr>";
				}
				else{
					echo "<td>" . $row['adm_prtUserNum'] . "</td>";
						echo "<td>" . $row['adm_prtlname'] ."$lnameholder " .$row['adm_prtfname'] . $row['adm_prtmname']. "</td>";
						echo "<td>" . $row['adm_prtusername'] . "</td>";
						echo "<td>" . $row['adm_prtstatus'] . "</td>";
						echo "<td>";
							echo '<a href="ParentView.php?id='. $row['adm_prtId'] .'"><button id="modify">View</button></a>';
