				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="" class="logo"><strong>Student </strong>Management</a>
									<ul class="icons"><?php
							...
							<!-- Banner -->
								<section id="banner">
									<div class="content">
										<header>
											<h2 id="titleview">Student Users List</h2>
										</header>
										<div id ="viewAdmin">
											<table>
												<tr>
...
function Display(){
    ...
    $sql = "select * from adm_StudentUser";
    ...
    if($result = mysqli_query($db, $sql)){
        if(mysqli_num_rows($result) > 0){
            while($row = mysqli_fetch_array($result)){
				...
				if(isMobileDevice()){
					echo "<tr>";
						echo "<td>" . $row['adm_stdlname'] ."$lnameholder " .$row['adm_stdfname'] . $row['adm_stdmname']. "</td>";
						echo "<td>" . $row['adm_stdstatus'] . "</td>";
						echo "<td>";
						echo '<a href="StudentView.php?id='. $row['adm_stdAdminId'] .'"><button id="modify">View</button></a>';
							// echo '<a href="update.php?id='. $row['adm_stdAdminId'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
							// echo '<a href="delete.php?id='. $row['adm_stdAdminId'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
						echo "</td>";
					echo "</tr>";
				}
				else{
					echo "<td>" . $row['adm_stdUserNum'] . "</td>";
						echo "<td>" . $row['adm_stdlname'] ."$lnameholder " . $row['adm_stdfname'] . $row['adm_stdmname']. "</td>";
						echo "<td>" . $row['adm_stdusername'] . "</td>";
						echo "<td>" . $row['adm_stdstatus'] . "</td>";
						echo "<td>";
							echo '<a href="StudentView.php?id='. $row['adm_stdId'] .'"><button id="modify">View</button></a>';
							// echo '<a href="update.php?id='. $row['adm_stdAdminId'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
							// echo '<a href="delete.php?id='. $row['adm_stdAdminId'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
						echo "</td>";
					echo "</tr>";
