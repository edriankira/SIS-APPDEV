...
if(isset($_POST['goAdd'])){
	...
	$isExist = true;
        ...
        do{
            ...
            $sql1 = "SELECT adm_stdUserNum from adm_StudentUser where adm_stdUserNum = $AD_adminID";
	...
	if(empty($input_email)){
		...
		$downsql1 = 'SELECT adm_stdemail from adm_StudentUser where adm_stdemail = "'.trim($_POST["email"]).'" ';
	...
	if(empty($input_mobile)){
		...
		$downsql2 = 'SELECT adm_stdmobile from adm_StudentUser where adm_stdmobile = "'.trim($_POST["mobile"]).'" ';
							...
							<!-- Banner -->
								<section id="banner">
									<div class="content">
										...
										<h2 id="titleAdd">Student Add User</h2>
											...
											<tr>
												<td colspan = 3>Account Information<br><br>
													...
													<div class="form-group">
														...
														<input type="submit" name="goAdd" value="Add Student User" id="submit">
													</div>
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li><a href="#.php">Student Registration</a></li>
											</ul>
										</li>
										<li>
