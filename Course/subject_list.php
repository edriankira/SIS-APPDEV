				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="index.html" class="logo"><strong>Subject Management List</strong></a>
									<ul class="icons"><?php
                                            ...
                                            if(mysqli_num_rows($result) > 0){
                                                echo '<table class="table table-bordered table-striped">';
                                                    ...
                                                    while($row = mysqli_fetch_array($result)){
                                                        ...
                                                        echo "<td>";
                                                                echo '<a href="subject_read.php?id='. $row['Sub_ID'] .'" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span> View </a>&nbsp;  '; 
                                                                echo '<a href="subject_delete.php?id='. $row['Sub_ID'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span> Delete</a>';
                                                            echo "</td>";
                                                        echo "</tr>";
                                                    }
                                                    echo "</tbody>";                            
